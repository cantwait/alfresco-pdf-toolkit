...

{
    ...
    protected void executeImpl(Action ruleAction, NodeRef actionedUponNodeRef)
    {
        ...
        NodeRef watermarkNodeRef = (NodeRef) ruleAction
                .getParameterValue(PARAM_WATERMARK_IMAGE);

        if (this.nodeService.exists(watermarkNodeRef) == false)
        {
        ...
        if (actionedUponContentReader != null && watermarkContentReader != null)
        {
            // Add the watermark to the image
            doWatermark(ruleAction, actionedUponNodeRef, watermarkNodeRef,
            		actionedUponContentReader, watermarkContentReader);
    ...
    protected void doWatermark(Action ruleAction, NodeRef actionedUponNodeRef,
            ...
            ContentReader watermarkContentReader)
    {
        ...
        try
        {
            this.action(ruleAction, actionedUponNodeRef, watermarkNodeRef,
