...

{
    ...
    protected void addParameterDefinitions(List<ParameterDefinition> paramList)
    {
        ...
        paramList.add(new ParameterDefinitionImpl(PARAM_WATERMARK_PAGES, DataTypeDefinition.TEXT, true, getParamDisplayLabel(PARAM_WATERMARK_PAGES), false, "pdfc-page"));
